package test.java.pentaho.reporting;
...
//			final URL reportDefinitionURL = classloader.getResource("src/main/resources/Sample1.prpt");
			final URL reportDefinitionURL = classloader.getResource("Sample1.prpt");
