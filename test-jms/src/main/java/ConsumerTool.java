...
public class ConsumerTool extends Thread implements MessageListener, ExceptionListener {
	...
	private String clientId = "consumer2";
	private int ackMode = Session.AUTO_ACKNOWLEDGE;
	private String consumerName = "FuryEgg";
	...
	protected void consumeMessagesAndClose(Connection connection, Session session, MessageConsumer consumer, long timeout) throws JMSException,
			IOException {
