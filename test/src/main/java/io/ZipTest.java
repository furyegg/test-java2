...
/**
 * A frame with a text area to show the contents of a file inside a ZIP archive, a combo box to select different files
 * in the archive, and a menu to load a new archive.
 */
