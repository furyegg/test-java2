...
public class CompilerTest
{
   public static void main(final String[] args) throws IOException
   {
      ...
      JavaFileObject source = buildSource("script.CompilerTest.ButtonFrame");
   ...
   static JavaFileObject buildSource(String superclassName) throws IOException
   {
      ...
      props.load(new FileReader("src/main/java/script/CompilerTest/action.properties"));
