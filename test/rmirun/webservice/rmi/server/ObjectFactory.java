 ...
 * generated in the rmi.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetPrice_QNAME = new QName("http://rmi/", "getPrice");
    private final static QName _GetPriceResponse_QNAME = new QName("http://rmi/", "getPriceResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: rmi.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rmi/", name = "getPrice")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rmi/", name = "getPriceResponse")
